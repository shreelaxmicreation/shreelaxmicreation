...
export default async function ProductsPage() {
  const productsRaw = await client.fetch<SanityProduct[]>(productsQuery)
  const products = productsRaw ? JSON.parse(JSON.stringify(productsRaw)) : [];
  ...
  return (
    <>
      ...
      <ProductsGrid mode="full" showHeader={false} products={products} />
